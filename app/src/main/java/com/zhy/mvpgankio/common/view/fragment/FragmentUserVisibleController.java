package com.zhy.mvpgankio.common.view.fragment;
 ...
 * 2. 重写Fragment的onActivityCreated()、onResume()、onPause()、setUserVisibleHint(boolean)方法，
