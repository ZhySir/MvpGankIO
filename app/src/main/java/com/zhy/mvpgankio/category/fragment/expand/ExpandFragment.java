...
public class ExpandFragment extends BaseFrameFragment<ExpandPresenter, ExpandModel>
    ...
    public void initView() {
        super.initView();
        mRefreshLayout = getAc().findViewById(R.id.mRefreshLayout_Expand);
    ...
    private void lazyInitData() {
        ...
        /* 默认进入查询 */
        mPresenter.getCategoryData("拓展资源", PAGE_NUM, PAGE_SIZE, 0);
    }
    ...
    public void initListener() {
        ...
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                PAGE_NUM = 1;
                /* 刷新查询 */
                mPresenter.getCategoryData("拓展资源", PAGE_NUM, PAGE_SIZE, 1);
            }
        });
        mRefreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                PAGE_NUM = PAGE_NUM + 1;
                /* 加载更多查询 */
                mPresenter.getCategoryData("拓展资源", PAGE_NUM, PAGE_SIZE, 2);
            }
        });
    }
